...
import { getTokensAllowed } from "./getAddresses";
                      ...
                      <div className="flex flex-col items-center border border-transparent-color-gray-200 rounded-xl md:min-w-[500px] md:w-max py-2">
                            ...
                            return (
                              <div
                                className={clsx(
                                  ...
                                  {
                                    "bg-[#000000] border-[#47e439] shadow-[0_0px_10px] shadow-[#47e439]":
                                      tokenSelected == item.address,
                                  },
                                )}
                                onClick={() => {
                        ...
                        <div className="w-full flex items-center justify-center py-2">
                          <div
                            ...
                            className="w-auto px-6 py-2 flex justify-center items-center rounded-xl hover:border-[#47e439] hover:bg-[#000000] hover:text-[#47e439] border border-transparent-color-gray-200 cursor-pointer bg-[#47e439] font-bold text-[#000000] transition-all duration-500"
                          >
                            Checkout
                          </div>
                        </div>
