        ...
        <div className="relative container-input">
          <input
            ...
            className={clsx(
              ...
              "placeholder-white-disabled  w-full font-montserrat border-b-0.5 border-gray-200",
              {
            ...
            onChange={(e) => {
              registerAux ? registerAux.onChange(e) : undefined; // method from hook form register
              onChangeCustom ? onChangeCustom(e) : undefined; // your method
