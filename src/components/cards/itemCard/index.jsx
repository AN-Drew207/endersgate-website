...
import { getContractCustom } from "@/components/common/contracts";
import { useDispatch, useSelector } from "react-redux";
import { getAddresses } from "@/components/common/getAddresses";
import { onGetAssets, setAssets } from "@/redux/nft_actions";
          ...
          >
            {transfer && (
              ...
              >
                ...
                >
                  <div className="flex flex-col items-center relative w-full rounded-xl bg-[#0a0a0a] border border-white">
                    {loading ? (
                      ...
                      <div className="relative flex flex-col items-center">
                        ...
                        <div className="flex flex-col w-full items-center">
                          ...
                          <div className="flex xl:flex-row flex-col justify-center items-center gap-2  py-4 w-full">
                            ...
                            <div
                              className="relative cursor-pointer border border-[#47e439] rounded-xl"
                              onClick={() => transferNft()}
                            >
                              <div className="p-1 px-4 flex relative items-center">
                                <span
